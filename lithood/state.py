...
class StateManager:
        ...
        return [
            {
                ...
                "funding_earned": (
                    Decimal(row["funding_earned"]) if row["funding_earned"] else None
                ),
    ...
    def get_grid_stats(self) -> dict:
        ...
        return {
            ...
            "total_volume": Decimal(str(fills["total_volume"])) if fills["total_volume"] else Decimal("0"),
        }
